  ...
  <div class="app-container">
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24">
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="用户学号" align="center" key="studyId" prop="studyId" v-if="columns[2].visible" :show-overflow-tooltip="true" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-row>
          <el-col :span="12">
            <el-form-item label="用户学号" prop="studyId">
              <el-input v-model="form.studyId" placeholder="请输入用户学号" maxlength="30" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
